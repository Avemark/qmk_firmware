...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_5x6(
     ...
     SFT_SLS , KC_A  , KC_R  , KC_S  , KC_T  , KC_D  ,                         KC_H  , KC_N  , KC_E  , KC_I  , KC_O    ,SFT_CLN,
  ...
  [_SPECIAL] = LAYOUT_5x6(
     ...
     _______,_______,_______,KC_LBRC,KC_RBRC,_______,                          _______,_______, KC_UP ,_______,_______,_______,
     KC_BSLS,KC_LABK,KC_RABK,KC_LPRN,KC_RPRN,KC_DQUO,                          _______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,
